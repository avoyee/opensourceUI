...
static int effanimation_updatevalue(EffAnimation* anim, int time)
{
    ...
    if (anim->calcValue) {
		...
		_DBG_PRINTF("%s:anim->startvalue = %f, endvalue = %f, currentvalue = %f\n", 
		   __FUNCTION__, *(float*)anim->startvalue, *(float*)anim->endvalue, *(float*)anim->currentvalue);
    if (anim->setProperty) {
...
int effanimation_setcurrenttime(EffAnimation* anim, int currenttime)
{
    ...
    _DBG_PRINTF("%s: anim->currenttime = %d, totaltime = %d, anim->loopcount = %d\n", __FUNCTION__, anim->currenttime, 
            anim->duration * anim->loopcount, anim->loopcount);
    ...
    _DBG_PRINTF("%s:time = %d, anim->currentloop = %d, anim->currenttime = %d ,total_time = %d\n", __FUNCTION__, 
            time, anim->currentloop, anim->currenttime,total_time);
