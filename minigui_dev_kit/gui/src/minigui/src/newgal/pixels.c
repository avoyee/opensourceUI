    ...
    default:
        switch (dstfmt->BytesPerPixel) {
            ...
            else
            {
                ...
                /*fprintf(stderr,"A :bpp rmask amask %d %x %x B:bpp rmask amask %d %x %x \n",\
                srcfmt->BitsPerPixel,srcfmt->Rmask,srcfmt->Amask,\
                dstfmt->BitsPerPixel,dstfmt->Rmask,dstfmt->Amask);
                */
            }
            break;
        }
