...
static void mcUnHilightRect (HWND hWnd, PMONCALDDATA mc_data, HDC hdc, RECT* prcItem, unsigned char day)
{
    int item_w, item_h;
    char daytext[5];
    PMCCOLORINFO pmcci;
...
static void mcHilightRect (HWND hWnd, PMONCALDDATA mc_data, HDC hdc, RECT* prcItem, unsigned char day)
{
    int item_w, item_h;
    char daytext[5];
    PMCCOLORINFO pmcci;
...
{
    unsigned char i, WeekDayPM = 0, LineIndex = 0;
    unsigned char mdaypm = 0, MonLenPM, mdaynm;
    int iWeekDay = 0;
    char chMonthDay[5];
    RECT rcMonthDay;
    PMCCOLORINFO pmcci;
